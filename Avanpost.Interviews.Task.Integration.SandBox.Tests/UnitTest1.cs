...
namespace Avanpost.Interviews.Task.Integration.SandBox.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = "Server=host.docker.internal,1443;Database=testDb;User ID=SA;Password=1StrongPwd!!;TrustServerCertificate=True;";
        static string postgreConnectionString = "";
        static Dictionary<string, string> connectorsCS = new Dictionary<string, string>
        {
            { "MSSQL",$"ConnectionString='{mssqlConnectionString}';Provider='SqlServer.2022';SchemaName='AvanpostIntegrationTestTaskSchema';"},
